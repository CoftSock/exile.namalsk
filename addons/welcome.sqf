...
// First
_title             = "Welcome!";
_shorttext         = "Arma 3 Exile by Armaclub";
_posText        = [0.8,0.5,0.4];


_title2         = "Join our Website!";
_shorttext2     = "www.armaclub.com";
_posText2        = [0.8,0.5,0.25];


_title3            = "Join Us in TeamspeakQ";
_shorttext3     = "ts3.armaclub.com";
_posText3        = [0.8,0.5,0.25];


_title4         = "Donate";
_shorttext4     = "Join us on Teamspeak or the Website<br />to support the server and help it stay online";
_posText4        = [0.8,0.5,0.28];


_title5         = "Custom Scripts";
_shorttext5     = "Towing and Crate Loading<br />AI Missions<br />Custom Traders<br />Spawn Quad in XM8<br />";
