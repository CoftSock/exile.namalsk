...
_servicePointClasses = ["Land_fs_feed_F","Land_CarService_F","Land_CargoBox_V1_F","Land_FuelStation_Feed_F","Land_Ind_FuelStation_Feed_EP1"]; // service point classes (can be house, vehicle and unit classes)
