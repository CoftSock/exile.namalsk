...
//App 1
_app1Text = "Vehicle Tracking";
_app1Logo = "xm8Apps\images\vt.paa";
app1_action = {
execVM "xm8Apps\Custom_Apps\1.sqf";
};

//App 2
_app2Text = "FPS Display";
_app2Logo = "xm8Apps\images\fps.paa";
app2_action = {
execVM "xm8Apps\Custom_Apps\fps.sqf";
};

//App 3
_app3Text = "Selfie";
_app3Logo = "xm8Apps\images\cam.paa";
app3_action = {
execvm "xm8Apps\Custom_Apps\selfie.sqf";
};

//App 4 
_app4Text = "EBase";
_app4Logo = "xm8Apps\images\eBase.paa";
app4_action = {
execVM"xm8Apps\Custom_Apps\eBase.sqf";
};
//App 5 
_app5Text = "Deploy Bike";
_app5Logo = "xm8Apps\images\bike.paa";
app5_action = {
execVM"xm8Apps\Custom_Apps\spawn_bike.sqf";
};

//App 6 
_app6Text = "Server Info";
_app6Logo = "xm8Apps\images\xm8_applogo.paa";
app6_action = {
execVM "xm8Apps\Custom_Apps\rules.sqf";
};
...
app7_action = { 
execVM"xm8Apps\Custom_Apps\ViewDistance.sqf";
};

//App 8
_app8Text = "Player Stats";
_app8Logo = "xm8Apps\images\Stats_IconWhite.paa";
app8_action = {
  execVM"xm8Apps\Custom_Apps\PlayerStats.sqf";
};

//App 10
_app10Text = "CookBook";
_app10Logo = "xm8Apps\images\BRAma.paa";
app10_action = {
  execVM"xm8Apps\Custom_Apps\BRAma.sqf";
};

//App 11
_app11Text = "Weather";
_app11Logo = "xm8Apps\images\";
app11_action = {
execvm "xm8Apps\Custom_Apps\weather.sqf";
};
