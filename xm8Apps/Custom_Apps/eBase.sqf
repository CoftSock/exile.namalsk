...
['Exile_Item_WoodPlank',40],
['Exile_Item_WoodSupportKit',4],
['Exile_Item_WoodWallKit',4],
['Exile_Item_WorkBenchKit',1]
];
box4Cost = 60000;
box4DonorCost = 25000;
...
['Exile_Item_MetalBoard',40],
['Exile_Item_MetalPole',40],
...
fnc_deliverynotify = {
  uiSleep 20;
  hint format["Dear Customer: %1, Your order is complete and your package has been delivered right to your not-yet-existent front door - Buy it, build it, love it! - altf4gaming.com",name player];
};

fnc_ordernotify = {
  hint format["Dear Customer: %1, thanks for your order! your order number is '%2-%3%4%5%6%7%8' - altf4gaming.com",name player, orderIDcharacters, a1, a2, a3, a4, a5, a6, a6, a7, a8];
};
